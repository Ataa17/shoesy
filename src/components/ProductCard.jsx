...
const ProductCard = ({product}) => {
  return (
    <div className='hover:bg-blue-50  hover:border-blue-300 border-1  border-transparent transition-colors ease-in-out duration-500 flex flex-col m-1 p-5 rounded-xl '>
